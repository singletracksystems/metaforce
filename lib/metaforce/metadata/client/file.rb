    ...
    class Client
      module File
        ...
        def describe(version = nil)
          body = {}
          body[:api_version] = version unless version.nil?
          request(:describe_metadata, message: body)
        end
        ...
        def _deploy(zip_file, options = {})
          request(:deploy, message: {
            :zip_file => zip_file, :deploy_options => options
          })
        end
